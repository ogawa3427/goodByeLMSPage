...
2. Chrome の場合  
[Chrome:拡張機能を管理](chrome://extensions/)から、画面右上の開発者モードをONにしたら左上の「パッケージ化されていない拡張機能を読み込む」をクリック。さっき解凍したしたフォルダを選択する
...
3. [Chrome:拡張機能を管理](chrome://extensions/)を開き、右上の「デベロッパーモード」をONにしてから左上の **更新** ボタン（丸矢印）を押す
